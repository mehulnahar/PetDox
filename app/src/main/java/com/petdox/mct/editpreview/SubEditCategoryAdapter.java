 ...
 */
public class SubEditCategoryAdapter extends RecyclerView.Adapter<SubEditCategoryAdapter.SubCategoryViewHolder> {
    ...
    public SubEditCategoryAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull SubCategoryViewHolder holder, int position) {
        ...
        holder.main_category.setOnClickListener(v -> {
            ...
            if (subCategoryModel.isSaved()) {
                ...
                if (EditPreviewActivity.selectedCategoryModelList != null && EditPreviewActivity.selectedCategoryModelList.size() == 10) {
                    new StyleableToast
                            .Builder(context)
